        ...
        cate2.items = [
          {
            ...
            value: {
              set() {
                window.open(
                  '/mybricks-app-harmony-application/index.html?id="--replace-id--"'
                );
              },
            },
          },
